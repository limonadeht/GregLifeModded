...
public class GuiGregLifeInfuser extends GuiContainer{

	private int x, y, z;
	private EntityPlayer player;
	private World world;
	private int sizeX, sizeY;
	private ResourceLocation backgroundimage = new ResourceLocation("greglife", "textures/gui/infuserGui.png");
	private TileGregLifeInfuser infuser;

	public GuiGregLifeInfuser(EntityPlayer player, World world, int x, int y, int z) {
		super(new ContainerGregLifeInfuser((TileGregLifeInfuser) world.getTileEntity(x, y, z), player, 176, 200));
		this.x = x;
		this.y = y;
		this.z = z;
		this.player = player;
		...
		sizeX = 176;
		sizeY = 200;
		infuser = (TileGregLifeInfuser) world.getTileEntity(x,y,z);
	}
