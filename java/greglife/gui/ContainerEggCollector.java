...
public class ContainerEggCollector extends Container{

	private TileEggCollector machine;

	public int lastProgress;

	public ContainerEggCollector(InventoryPlayer invPlayer, TileEggCollector tileentity){
