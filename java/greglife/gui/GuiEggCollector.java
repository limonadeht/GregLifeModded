...
public class GuiEggCollector extends GuiContainer{

	public static final ResourceLocation TEXTURE = new ResourceLocation("greglife", "textures/gui/guiNeutron.png");

	public TileEggCollector machine;

	private int guiUpdateTick;

	public GuiEggCollector(InventoryPlayer invPlayer, TileEggCollector tile){
		super(new ContainerEggCollector(invPlayer, tile));
		this.machine = tile;
	...
	public void drawGuiContainerForegroundLayer(int mouseX, int mouseY){
	    ...
	    this.fontRendererObj.drawString("Egg Collector", nmPos, 6, 7718655);
