...
public class BlockLiquidGregLife extends BlockFluidClassic{
	...
	public BlockLiquidGregLife(Fluid fluid, Material material) {
		super(fluid, material);
		//this.setBlockName(name);
	}

	public BlockLiquidGregLife() {
		this(GLContent.liquidGregLife, Material.water);
	}
	...
	public void registerBlockIcons(IIconRegister register) {
		stillIcon = register.registerIcon("greglife:fluids/liquidGLStill");
		flowingIcon = register.registerIcon("greglife:fluids/liquidGLFlowing");
		this.blockIcon = stillIcon;
		GLContent.liquidGregLife.setIcons(stillIcon, flowingIcon);
	}
	...
	public String getUnlocalizedName(){
		return String.format("tile.%s%s", "greglife:", getUnwrappedUnlocalizedName(getUnwrappedUnlocalizedName(super.getUnlocalizedName())));
	}
