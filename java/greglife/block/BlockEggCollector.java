...
public class BlockEggCollector extends BlockContainer{

	private IIcon top, sides, front;
    private Random randy = new Random();

    public BlockEggCollector(String name){
        super(Material.iron);
    ...
    public IIcon getIcon(IBlockAccess world, int x, int y, int z, int side){
        if(side == 1)
            return top;
        int facing = 2;
        TileEggCollector machine = (TileEggCollector)world.getTileEntity(x, y, z);
        if(machine != null)
    ...
    public boolean onBlockActivated (World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9)
    {
        ...
        {
            player.openGui(GregLife.Instance, 3, world, x, y, z);
            return true;
        }
    }
    ...
    public void dismantleBlock(World world, int x, int y, int z){
		...
		TileEggCollector tileEntity = (TileEggCollector)world.getTileEntity(x, y, z);
		...
		TileEggCollector collector = (TileEggCollector)world.getTileEntity(x, y, z);
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack item)
    {
        ...
        if(tile instanceof TileEggCollector) {
        	TileEggCollector machine = (TileEggCollector)tile;
