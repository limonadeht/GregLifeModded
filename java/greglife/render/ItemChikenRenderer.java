...
public class ItemChikenRenderer implements IItemRenderer{
	...
	public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
		Entity mob = EntityList.createEntityByName(ItemNBTHelper.getString(item, "Name", "Chicken"), mc.theWorld);
		randomEntity = EntityList.createEntityByName(randomEntitys[(int)((Minecraft.getSystemTime() / 1000) % 18)], mc.theWorld);
		if (ItemNBTHelper.getString(item, "Name", "Chicken").equals("Any")) mob = randomEntity;
		//if (mob instanceof EntitySkeleton) ((EntitySkeleton)mob).setSkeletonType(ItemNBTHelper.getInteger(item, "SkeletonType", 0));

		if (mob == null) {
			mob = EntityList.createEntityByName("Chicken", mc.theWorld);
		}
		GL11.glPushMatrix();
