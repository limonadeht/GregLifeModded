...
public class ItemTank extends ItemBlock implements IFluidContainerItem{
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean bool){
		BlockTank generator = (BlockTank)this.field_150939_a;
		...
		if(GregLife.proxy.isShiftKeyDown()){
			list.add("-----------------------");
			list.add("Max Storage: " + generator.tankCapacity + " mb");
		}else{
